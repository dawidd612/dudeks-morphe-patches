...
**Keep TikTok DM scroll position** keeps older replies in view in TikTok Global **47.0.3** (`com.zhiliaoapp.musically`). Select it together with your [kveld9 patches](https://github.com/kveld9/kveld-morphe-patches) when patching a clean app. It is enabled by default; its Morphe description includes English and Polish.

**PL:** Patch zachowuje pozycję rozmowy po odpowiedzi na starszą wiadomość lub film. Jest domyślnie zaznaczony na liście patchy Morphe. Aby go wyłączyć, odznacz go i ponownie spatchuj aplikację. Nie dodaje panelu Piko do TikToka.
